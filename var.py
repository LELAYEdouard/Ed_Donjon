...
mob={0:["Skeleton",60,10]} # dont forget to increase NB_MOB if we add mob (name,PV,XP given)
fight_choice={0:[ATTACK,"Attack"],1:[RUN,"Run"]}
objects={0:["Potion",20]}# dont forget to increase NB_WOBJECT if we add object